"""DEPRECATED: legacy standalone recommender using hardcoded raw paths.

Use `python -m DataLayer.build_clean_users` and AccessRecommendationEngine flows instead.
"""
...
def main():
    print("=== DEPRECATED: recommend_rights_for_new_employee.py (legacy raw-data path) ===")
